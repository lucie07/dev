...
**TRUST**MEDICOS: Creating trust in health information on social networks by tackling shared misinformation project was funded by the European Union’s Horizon 2020 research and innovation programme under grant agreement No. 957228. It was selected as one of 45 funded projects funded through the TruBlo open calls, which supported innovative ideas toward “trustable content on future blockchains”. [TruBlo](https://www.trublo.eu/) was an EU-funded project and part of the NGI (Next Generation Internet) initiative. Within this wider programme, **TRUST**MEDICOS aimed to tackle health misinformation and achieve a trustworthy health information exchange.
...
As part of the **TRUST**MEDICOS team, and building on early proof-of-concept iterations, I translated these research insights and the project’s wider objectives into practical digital experiences for different user groups. I designed dashboard concepts and user interfaces, produced end-user mockups, and mapped user journeys and system use case diagrams for **TRUST**MEDICOS users and trusted health experts. This involved considering how users would assess the credibility of health information, interact with the platform’s trust and reputation features, and navigate complex information in a clear and accessible way.

My contributions also extended to the project’s research findings. Working closely with the project lead, I designed and prepared the research publication *Tackling health misinformation in social media: Understanding the role of psychological and technological biases in content moderation*, which was published in May 2022. This white paper was one of the project’s three outputs. The publication brought together the project’s problem statement, a review of existing initiatives against misinformation, the role of filter bubbles and algorithmic biases, and a schematic overview of the **TRUST**MEDICOS solution concept, as well as diagrams and visual design to present the project’s methodology, technological approach and intended impact to both specialist and wider audiences.

### Project Links

- [TRUBLO profile](https://www.trublo.eu/trustmedicos/)
- [**TRUST**MEDICOS Whitepaper](https://www.academia.edu/77852423/Tackling_health_misinformation_in_social_media_Understanding_the_role_of_psychological_and_technological_biases_in_content_moderation)
