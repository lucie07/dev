...
<template>
  ...
  >
    <div class="border dark:border-[#5E5E5E] p-3 rounded-md dark:bg-[#2E2E2E] bg-white/90 backdrop-blur-sm shadow-lg">
      <h2 class="text-sm font-bold mb-3 border-b dark:border-[#5E5E5E] pb-2">Table of Contents</h2>
      <nav>
