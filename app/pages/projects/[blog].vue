...
const { previousPost, nextPost } = await useBlogNavigation(contentPath.value)
  ...
  <div>
    <div class="px-6 container max-w-5xl mx-auto">
      <div>
        ...
        <div
          class="prose prose-pre:max-w-xs sm:prose-pre:max-w-full prose-sm sm:prose-base md:prose-lg prose-h1:no-underline max-w-5xl mx-auto prose-zinc dark:prose-invert prose-img:rounded-none prose-img:block prose-img:mx-auto"
        >
